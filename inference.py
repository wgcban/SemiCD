...
def parse_arguments():
    ...
    parser.add_argument('--config', default='/media/lidan/ssd2/SemiCD/saved/LEVIR-WHU/ours/SemiCD_(LEVIR-sup-40)_(WHU-unsup)/config.json',type=str,
                        help='Path to the config file')
    parser.add_argument( '--model', default='/media/lidan/ssd2/SemiCD/saved/LEVIR-WHU/ours/SemiCD_(LEVIR-sup-40)_(WHU-unsup)/best_model.pth', type=str,
