...
def main(config, resume):
    ...
    model = models.AdvNet(num_classes=val_loader.dataset.num_classes, conf=config['model'],
...
if __name__=='__main__':
    ...
    parser.add_argument('-c', '--config', default='configs/config_LEVIR-WHU.json',type=str,
