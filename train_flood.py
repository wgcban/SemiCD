...
def main(config, resume):
    ...
    supervised_loader = dataloaders.FLOOD(config['train_supervised'])
    unsupervised_loader = dataloaders.FLOOD(config['train_unsupervised'])
    val_loader = dataloaders.FLOOD(config['val_loader'])
