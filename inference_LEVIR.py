...
def parse_arguments():
    ...
    parser.add_argument('--config', default='/media/lidan/ssd2/SemiCD/saved/LEVIR-CD/AdvNet/AdvNet_(semi)_40/config.json',type=str,
                        help='Path to the config file')
    parser.add_argument( '--model', default='/media/lidan/ssd2/SemiCD/saved/LEVIR-CD/AdvNet/AdvNet_(semi)_40/best_model.pth', type=str,
